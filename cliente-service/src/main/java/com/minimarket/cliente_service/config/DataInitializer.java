...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        clienteRepository.save(new Cliente(null, "11111111-1", "Carlos", "Rodríguez", "carlos.rodriguez@gmail.com", true));
        clienteRepository.save(new Cliente(null, "22222222-2", "Ana", "Martínez", "ana.martinez@gmail.com", true));
        clienteRepository.save(new Cliente(null, "33333333-3", "Pedro", "López", "pedro.lopez@gmail.com", false));
        clienteRepository.save(new Cliente(null, "44444444-4", "Valentina", "Soto", "vale.soto@gmail.com", true));
        ...
        clienteRepository.save(new Cliente(null, "77777777-7", "Sebastián", "Morales", "seba.morales@gmail.com", false));
        clienteRepository.save(new Cliente(null, "88888888-8", "Fernanda", "Castro", "fer.castro@gmail.com", true));
        ...
        clienteRepository.save(new Cliente(null, "12121212-1", "Matías", "Herrera", "matias.herrera@gmail.com", false));
        clienteRepository.save(new Cliente(null, "13131313-1", "Francisca", "Núñez", "francy.nunez@gmail.com", true));
        ...
        clienteRepository.save(new Cliente(null, "16161616-1", "Rodrigo", "Torres", "rodri.torres@gmail.com", false));
        clienteRepository.save(new Cliente(null, "17171717-1", "Daniela", "Flores", "dani.flores@gmail.com", true));
